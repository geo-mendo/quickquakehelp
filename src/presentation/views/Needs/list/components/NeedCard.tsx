...
import { IGeolocation } from "../../../../../data/models/IGeolocation";
    ...
    <Card key={props.id} className="mt-10 w-full">
      <CardBody>
        ...
        <div className="flex justify-between items-center px-2 mb-2">
            ...
            <Typography>
                <span className="font-bold">Localisation:</span> <a className="inline-block text-blue-500" > <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-geo-alt" viewBox="0 0 16 16">
